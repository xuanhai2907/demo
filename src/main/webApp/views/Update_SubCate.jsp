...
<body>
<div id="main">
    <h1>Update Sub Category with ID = ${getSubcate.getId()}</h1>
    <br>
    <br>
    <%--@elvariable id="getSubcate" type="java"--%>
    <form:form method="POST"
               action="/categories/updateSubCate/${getSubcate.getId()}"
    ...
    <form:form
                method="post"
                action="../../categories/deleteSubCate/${getSubcate.getId()}"
